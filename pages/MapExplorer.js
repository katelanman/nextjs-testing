...
export default function MapExplorer() {
  ...
  const [currVar, setVar] = useState("Var1");
  ...
  const Filter = (
        ...
        <div id={styles.FilterItems} className={filterVisible ? '' : styles.ContentInvisible}>
          ...
          <FilterSelector name="Variable" range={['Var1', 'Var2', 'Var3']} onChange={setVar} selected={currVar}/>
          <button><a href='DataDownloader'>Download Data</a></button>
        </div>
        </div>
    );

  return (<Layout currPage='Map Explorer'> 
